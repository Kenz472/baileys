...
const { randomUUID, randomBytes } = crypto_1;
...
const toTableMetadataV2 = (arr) => {
  // PERBAIKAN: Sanitasi input agar jika bernilai undefined/null/bukan array, dikonversi menjadi array kosong [] agar tidak throw error
