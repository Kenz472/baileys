...
const makeSocket = (config) => {
    ...
    const onUnexpectedError = (err, msg) => {
        ...
        if (message.includes('429') || message.includes('rate limit') || message.includes('rate-limit') || message.includes('overlimit') || message.includes('over-limit')) {
    ...
    const end = (error) => {
        ...
        const isTimeoutError = errorMessage.includes('opening handshake has time out') || 
...
function mapWebSocketError(handler) {
    return (error) => {
        ...
        if (errorMessage.includes('opening handshake has time out') || 
