...
const ffmpeg_1 = require("fluent-ffmpeg");
  ...
  static getMp4Preview(
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        const inputStream = new Readable.Readable({ read() {} });
  ...
  async toCard() {
    return {
      ...
      header: {
        ...
        ...(this._data
          ? await Utils_1.prepareWAMessageMedia(this._data, {
...
class ButtonV2 extends BaseBuilder {
  ...
  addButton(displayText = "", buttonId = crypto_1.randomUUID()) {
    this._buttons.push({
      buttonId,
